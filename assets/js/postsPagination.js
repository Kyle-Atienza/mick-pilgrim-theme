...
const reviewPosts = Array.from(document.querySelectorAll(".review-post"));
...
function renderPagination() {
    if (!paginationList || !reviewPosts.length) return;

    const totalPages = Math.ceil(reviewPosts.length / itemsPerPage);
